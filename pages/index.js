    ...
    <div style={{ minHeight: '100vh', background: 'white', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '20px 16px', alignItems: 'center' }}>
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <div style={{ width: '44px', height: '44px', background: '#0f172a', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', color: 'white' }}>R</div>
      ...
      <div style={{ textAlign: 'center', paddingTop: '30px' }}>
        <div style={{ width: '110px', height: '110px', background: '#0f172a', borderRadius: '28px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '50px' }}>🛒</div>
